...
const MainContainer = () => {
  return (
    <div className="w-[86.5rem] h-[86vh] overflow-x-scroll no-scrollbar py-5 px-10 bg-gray-100">
      <div className="flex justify-between items-center">
        <h1 className="text-2xl font-extrabold">Courses</h1>
        <p className="text-xs">Dashboard / Courses</p>
      </div>
      <hr className="my-4" />
        ...
        <table className="w-full text-sm text-left">
          ...
          <tbody>
            <tr className="bg-white border-b">
              ...
              <td className="px-6 py-3">React & Tailwind CSS</td>
