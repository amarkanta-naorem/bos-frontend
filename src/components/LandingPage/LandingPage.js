    ...
    >
      ...
      <div className="my-5 md:my-16 md:mx-10">
        <div className="text-center mx-auto md:w-1/2">
          <h1 className="text-2xl xs:text-3xl md:text-4xl font-extrabold text-white">
            {BannerCourses.heading}
          </h1>
          <p className="p-3 md:pt-8 text-white text-xs xs:text-sm md:text-lg">{BannerCourses.description}</p>
        </div>
      ...
      <div className="text-center md:text-lg mt-5 md:my-10 mx-auto md:w-1/2">
        ...
        <p className="p-3 md:pt-8 text-white text-xs xs:text-sm md:text-lg">
          Begin your learning journey with us today!
        </p>
      </div>
      <Topic />

      <div className="relative md:w-full mx-3 p-4 md:p-8 py-[3rem] md:py-[8rem]">
        <img
        ...
        <div className="relative z-10 flex flex-col items-center justify-center space-y-2 md:space-y-4 text-center">
          <img
              className="w-5 h-5 xs:w-7 xs:h-7 md:w-16 ms:h-16"
              src={Dicord}
              alt="Discord Logo"
          />
