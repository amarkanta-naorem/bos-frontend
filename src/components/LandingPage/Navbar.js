  ...
  return (
    <nav className="relative">
      <div className="flex flex-col md:flex-row md:items-center justify-between py-4 md:py-8 mx-3 md:mx-10">
        ...
        {/* Navbar Menu List */}
        <div className={`absolute md:static top-14 z-10 md:z-auto bg-gray-950 md:bg-transparent rounded-t-lg md:rounded-none flex w-[21rem] md:w-auto ${isMenuOpen ? 'block' : 'hidden'} md:block`}>
