...
const Table = () => {
  return (
    <Fragment>
      <div className="overflow-x-scroll md:no-scrollbar mx-5 md:px-10 mt-5 md:mt-10 mb-20">
        <table className="w-full text-sm text-left">
          ...
          <tbody>
            <tr className="bg-white border-b">
              ...
              <td className="px-3 py-3 md:px-6 md:py-6">React & Tailwind CSS</td>
              <td className="px-3 py-3 md:px-6 md:py-6">
                A short description of a project of React and Tailwind CSS.
              </td>
              <td className="px-3 py-3 md:px-6 md:py-6">John Doe</td>
              <td className="px-3 py-3 md:px-6 md:py-6">
                <svg
