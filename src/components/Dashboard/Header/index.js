    ...
    <nav className="w-full h-[14vh] flex justify-between items-center py-9 px-5 shadow">
      ...
      <div>
        <ul className="flex items-center">
          <li className="mx-3 cursor-pointer border-2 border-teal-950 hover:bg-teal-700 hover:border-teal-700 hover:text-white px-5 py-1 rounded-md text-xl font-semibold">
            POS
          </li>
          ...
          <li className="mx-3 cursor-pointer">
            <button className="bg-teal-950 p-2 rounded-md">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 512 512"
                height="25px"
